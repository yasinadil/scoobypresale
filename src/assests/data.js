...
export const roadmap = [
  {
    ...
    points: [
      ...
      "Launch on Uniswap",
      "	CMC & CG listing ",
      "	Get $SCOOBY Trending on twitter with our memetic power",
    ],
...
export const FAQ = [
  ...
  {
    q: "3.	Why the Scooby Doo token? ",
    ans: [
      "As a new player in the crypto arena, $SCOOBY offers both early adopters and seasoned investors a fresh opportunity to be part of a rising star. ",
    ],
  },
  {
